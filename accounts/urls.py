...
urlpatterns = [
    ...
    path('upload-progress-picture/', views.upload_progress_picture, name='upload_progress_picture'),
    path('delete_progress_picture/<int:picture_id>/', views.delete_progress_picture, name='delete_progress_picture'),
